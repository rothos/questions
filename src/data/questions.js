...
export const questions = [
    ...
    {
        text: "Are there any thoughts so offensive that you would advocate shaming those who think them? (given they aren't acting on those thoughts)",
        category: categories.THOUGHTFUL
    },
    {
    ...
    {
        text: "Bill Nye and Neil DeGrasse Tyson enter the Hunger Games arena. Who comes out alive?",
        category: categories.GENERIC
    },
    {
